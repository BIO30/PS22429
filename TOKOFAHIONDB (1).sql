...
select * from Categories where category_type = N'shirt'
...
, N'Simili',N'45cm X 30cm X 12cm',N'thêu trực tiếp'),
...
, N'Simili',N'40cm X 30cm X 12cm',N'thêu trực tiếp'),
...
, N'Canvas trượt nước',N'ngang 29, rộng 15, cao 41cm ',N'logo kim loại'),
...
N'Canvas pha Poly',N'40cm X 30cm X 12cm',N'Được in trực tiếp lên sản phẩm'),
